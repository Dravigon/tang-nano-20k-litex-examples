...
("sdram", 0,
    Subsignal("clk",   Pins(1)),   # SDRAM CLK
    Subsignal("cke",   Pins(1)),
    Subsignal("cs_n",  Pins(1)),
    Subsignal("ras_n", Pins(1)),
    Subsignal("cas_n", Pins(1)),
    Subsignal("wen_n",  Pins(1)),
    Subsignal("addr",     Pins(11)),  # 13 pins: A0..A12
    Subsignal("ba",    Pins(2)),                                              # BA0..BA1
    Subsignal("dq",    Pins(32)),  # 16 pins
    Subsignal("dqm",    Pins(4)),                                              # DM0..DM1
    IOStandard("LVCMOS33")
),
